    ...
    for file_name in files:    
        ...
        actions = [    
            {    
                ...
                "_source": row  # Specify document source  
            }    
            for row in df_dict  # Loop through each row in the DataFrame dictionary  
        ]    
  
        helpers.bulk(es, actions)  # Use Elasticsearch bulk API to index documents  
...
csv_to_elasticsearch(es, "tripadvisor_reviews", dir_path)    
